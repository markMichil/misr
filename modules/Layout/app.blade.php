...
<body class="frontend-page {{ !empty($row->header_style) ? "header-".$row->header_style : "header-normal" }} {{$body_class ?? ''}} @if(session('website_locale',app()->getLocale()) == 'egy') is-rtl @endif @if(is_api()) is_api @endif">
    @if(!is_demo_mode())
