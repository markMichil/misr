...
?>
    ...
    <div class="container inner_page_breadcrumb" style="<?php echo e($style); ?>">
        <div class="row">
            <div class="col-xl-6">
...
<!-- Our Contact -->
    ...
    <div class="container our-contact pb0 bgc-f7">
        <div class="row">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home3/misrprop/public_html/demo/themes/Findhouse/Contact/Views/frontend/blocks/contact/index.blade.php ENDPATH**/ ?>