...
<style>
	...
	'header-normal style2'); ?> <?php if(session('website_locale',app()->getLocale()) == 'egy'): ?> is-rtl <?php endif; ?>" style="height: 100px" >
		<div class="container p0 " style="width: 1200px">
		    ...
		    <nav>
				...
				<a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="navbar_brand float-left dn-smd" style="width: 180px ;margin-left: 20px;">
					<?php if((isset($is_homepage) && $is_homepage == true)): ?>
						<?php if($logo_id_tran = setting_item("logo_id_tran")): ?>
							...
							<img class="logo1 "  src="<?php echo e($logo_tran); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
						<?php endif; ?>
					<?php else: ?>
						<?php if($logo_id = setting_item("logo_id")): ?>
							<?php $logo = get_file_url($logo_id,'full') ?>
							<img class="logo1 "  src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
						<?php endif; ?>
					<?php endif; ?>
		            <?php if($logo_id = setting_item("logo_id")): ?>
                        <?php $logo = get_file_url($logo_id,'full') ?>
                        <img class="logo2 "  src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
					<?php endif; ?>
    ...
    ?>
					...
					<?php if(!Auth::id()): ?>
						<li class="list-inline-item">
							<a href="javascript:void(0)" class="btn"> <span class="dn-lg" data-toggle="modal" data-target="#login"><?php echo e(__('Login')); ?></span>
			...
			<div class="header stylehome1">
				<div class="main_logo_home2 text-center" onclick="window.location.href='<?php echo e(asset('/')); ?>'">
						...
						<?php if($logo_id = setting_item("logo_id_mb")): ?>
							<?php $logo = get_file_url($logo_id,'full') ?>
							<img class="nav_logo_img " src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
		...
		<nav id="menu" class="stylehome1 mm-menu_offcanvas">
			<ul>
				...
				<?php if(!Auth::id()): ?>
                    ...
                    <?php if(is_enable_registration()): ?>
					    <li><a href="<?php echo e(route('auth.register')); ?>"> <?php echo e(__('Register')); ?></a></li>
                    <?php endif; ?>
				<?php endif; ?>
...
<?php /**PATH /home3/misrprop/public_html/demo/themes/Findhouse/Layout/parts/header.blade.php ENDPATH**/ ?>