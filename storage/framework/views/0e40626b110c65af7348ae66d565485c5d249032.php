		...
		<div class="row">
			<div class="col-lg-12">
				<div class="home_two_map">
					<div class="map-canvas skin2 h660" id="bravo_results_map<?php echo e($random); ?>"></div>
				</div>
			</div>
		</div>
	</div>
...
<?php if(!empty($markers)): ?>
    ...
    ;?>
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\misr\themes/Findhouse/Template/Views/frontend/blocks/map/index.blade.php ENDPATH**/ ?>