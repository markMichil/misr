...
?>
	...
	'header-normal style2'); ?> <?php if(session('website_locale',app()->getLocale()) == 'egy'): ?> is-rtl <?php endif; ?>">
		<div class="container-fluid p0">
		    ...
		    <nav>
				...
				<a href="<?php echo e(url(app_get_locale(false,'/'))); ?>" class="navbar_brand float-left dn-smd" style="width: 180px">
			...
			<div class="header stylehome1">
				<div class="main_logo_home2 text-center" onclick="window.location.href='<?php echo e(asset('/')); ?>'">
						...
						<?php if($logo_id = setting_item("logo_id_mb")): ?>
							<?php $logo = get_file_url($logo_id,'full') ?>
							<img class="nav_logo_img mt20" src="<?php echo e($logo); ?>" alt="<?php echo e(setting_item("site_title")); ?>">
...
<?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\misr\themes/Findhouse/Layout/parts/header.blade.php ENDPATH**/ ?>