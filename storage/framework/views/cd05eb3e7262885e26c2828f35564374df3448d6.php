                ...
                <?php $__currentLoopData = $list_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-6 col-lg-3">
                        <a href="<?php echo e($item['link_more']); ?>" class="btn btn-default w100">
                            ...
                            ?>
                            <div class="icon_hvr_img_box" style="background-image: url(<?php echo e($img); ?>);">
                                <div class="overlay">
...
<?php endif; ?><?php /**PATH /home3/misrprop/public_html/demo/themes/Findhouse/Template/Views/frontend/blocks/offer-block/style_4.blade.php ENDPATH**/ ?>