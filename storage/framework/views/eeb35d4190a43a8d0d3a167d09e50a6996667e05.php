...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('themes/findhouse/css/bootstrap.min.css?v=2')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('themes/findhouse/css/style.css?v=2')); ?>">
    <!-- Responsive stylesheet -->
    <link rel="stylesheet" href="<?php echo e(asset('themes/findhouse/css/responsive.css?v=2')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('themes/findhouse/dist/frontend/css/frontend.css?v=2')); ?>">
<!-- Title -->
    <!-- Fonts -->
    ...
    <?php if(session('website_locale',app()->getLocale()) == 'egy'): ?>
        <link href="<?php echo e(asset('themes/findhouse/dist/frontend/css/rtl.css?v=2')); ?>" rel="stylesheet">
    <?php endif; ?>
...
<body class="frontend-page <?php echo e($body_class ?? ''); ?> <?php if(session('website_locale',app()->getLocale()) == 'egy'): ?> is-rtl <?php endif; ?>">
...
<?php /**PATH /home3/misrprop/public_html/demo/themes/Findhouse/Layout/app.blade.php ENDPATH**/ ?>