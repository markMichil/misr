<?php if(!empty($seo_meta)): ?>
    ...
    <?php
        ...
        if(!empty($page_title) and empty($seo_meta['is_homepage'])){
            $page_title .= " - ".setting_item_with_lang('site_title' ,false,'Misrrea');
        }
        if(empty($page_title)){
            $page_title = setting_item_with_lang('site_title' ,false,'Misrrea');
        }
...
<?php endif; ?>
<?php /**PATH D:\xampp\htdocs\misrea\findhouse.2.1.0\misr\themes/Findhouse/Layout/parts/seo-meta.blade.php ENDPATH**/ ?>